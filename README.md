...
<img src='./vibify-images/vibify-home.png' alt='Vibify homepage' height='350' width='500'>
...
- **Informational Section**
  <img src='./vibify-images/vibify-informational.png' alt="Vibify informational section" height='350' width='500'>
...
- **One-click playlist creation with a preset vibe (All users)**
  <img src='./vibify-images/vibify-preset-option.png' alt="Vibify preset playlist" height='350' width='500'>
...
- **Playlist creation through form input (All users)**
  <img src='./vibify-images/vibify-home.png' alt="Vibify playlist form" height='350' width='500'>

  - Any user can generate a playlist through this form, regardless of login status
    <img src='./vibify-images/vibify-playlist.png' alt="Vibify playlist logged in" height='350' width='500'>
  - Non-signed in users can play a 30-second preview of the song
    <img src='./vibify-images/vibify-logged-in-playlist.png' alt="Vibify playlist not logged in" height='350' width='500'>
...
- **User's Playlists Page (Signed in users only)**
  <img src='./vibify-images/vibify-logged-in-playlists.png' alt="Vibify playlists page" height='350' width='500'>
